...
const Modal = ({ isOpen, onClose, children }) => {
    ...
    return (
        <div className="absolute w-full inset-0 z-50 flex items-center justify-center">
            <div className="absolute w-full inset-0 bg-black/45 backdrop-blur-sm" onClick={onClose} />
